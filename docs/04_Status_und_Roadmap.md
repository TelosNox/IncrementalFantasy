...
**Danach:** Umsetzung durch Claude Code entlang der Meilensteine in `06_Implementierungsplan_Kapitel1.md`, beginnend bei M0; anschließend (erst nach M0–M10) Kapitel-2-Feinspec (Materia/Slots/AP/Magie, programmierbarer Gambit-Editor). Ladehinweis (CLAUDE.md): `03_Konzept_Gerüst.md` + betroffene `spec/*.md`, `02_Leitfaden_Kernmechaniken.md` als Prüfinstanz; für technische Umsetzung zusätzlich `05_Architektur.md` und der jeweilige Meilenstein-Abschnitt in `06_Implementierungsplan_Kapitel1.md`.
