...
⚠️ **B5 selbst ist weiterhin unbelegt.** Der gemessene Wert „3 Sessions, Zonen 1/16/30" stammt aus einer Simulation, die **Vaultron nie besiegt** und Wände überspringen lässt (zwei Fehler mit demselben Ursprung, `07_Umsetzungsentscheidungen.md` Entscheidung 59/60). Beide wirken **zugunsten** des Ergebnisses, der wahre Wert liegt daher vermutlich ≥ 3 – **aber gemessen ist er nicht.** Nachzumessen mit korrigierter Sonde.
