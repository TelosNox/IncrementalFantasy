...
**Umgesetzt (01.08.2026):** Bestiarium-Karte (`ui/BestiaryModal.svelte`) zeigt bei Gegnern mit Trait `heal` zusätzlich Heilmenge (`enemyHealAmount`) und Takt (`atbInterval` auf Basis der unskalierten SPD, wie die übrigen Bars der Karte) – z. B. Bandbox: „7 HP / ~2.0s". E4 ist damit belegt.
